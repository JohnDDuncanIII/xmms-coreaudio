...
static void configure_win_ok_cb(GtkWidget * w, gpointer data)
{
	...
	xmms_cfg_write_int(cfgfile, "OSX", "audio_device", osx_cfg.audio_device);
	xmms_cfg_write_int(cfgfile, "OSX", "mixer_device", osx_cfg.mixer_device);
	xmms_cfg_write_int(cfgfile, "OSX", "buffer_size", osx_cfg.buffer_size);
	xmms_cfg_write_int(cfgfile, "OSX", "prebuffer", osx_cfg.prebuffer);
	xmms_cfg_write_boolean(cfgfile,"OSX","use_master",osx_cfg.use_master);
	xmms_cfg_write_boolean(cfgfile, "OSX", "use_alt_audio_device", osx_cfg.use_alt_audio_device);
	xmms_cfg_write_string(cfgfile, "OSX", "alt_audio_device", osx_cfg.alt_audio_device);
	xmms_cfg_write_boolean(cfgfile, "OSX", "use_alt_mixer_device", osx_cfg.use_alt_mixer_device);
	xmms_cfg_write_string(cfgfile, "OSX", "alt_mixer_device", osx_cfg.alt_mixer_device);
...
void osx_configure(void)
{
	...
	gtk_window_set_title(GTK_WINDOW(configure_win), "OSX Driver configuration");
